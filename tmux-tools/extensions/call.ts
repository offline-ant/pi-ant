...
const ROOT_STATE_CUSTOM_TYPE = "pi-tmux:call-state";
const CALL_RUNTIME_CUSTOM_TYPE = "pi-tmux:call-runtime";
...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    name: CALL_TOOL,
    label: "Call",
    description: "Run a delegated task in a forked tmux pi worker and return its result. Uses /tool-model when configured. Nested call and retrospective are always enabled.",
